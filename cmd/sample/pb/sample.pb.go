...
type AmIATeapotResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
var file_sample_proto_rawDesc = []byte{
	...
	,
}
...
var file_sample_proto_goTypes = []interface{}{
	(*AmIATeapotRequest)(nil),  // 0: sample.AmIATeapotRequest
	(*AmIATeapotResponse)(nil), // 1: sample.AmIATeapotResponse
}
var file_sample_proto_depIdxs = []int32{
	0, // 0: sample.Teapot.AmIATeapot:input_type -> sample.AmIATeapotRequest
	1, // 1: sample.Teapot.AmIATeapot:output_type -> sample.AmIATeapotResponse
...
func file_sample_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_sample_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AmIATeapotRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_sample_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AmIATeapotResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
